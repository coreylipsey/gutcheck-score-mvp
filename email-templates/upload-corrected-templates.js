...
const TEMPLATES = [
  {
    name: 'Gutcheck Results Email (Corrected)',
    filename: 'results-email-corrected.html',
    description: 'Assessment results email with personalized score and AI recommendations',
    category: 'Transactional'
  },
  {
    name: 'Gutcheck Follow-up 1 - Signal Readout',
    filename: 'followup-1-corrected.html',
    description: 'First follow-up email with action plan and progress tracking',
    category: 'Engagement'
  },
  {
    name: 'Gutcheck Follow-up 2 - Signal Progression',
    filename: 'followup-2-corrected.html',
    description: 'Second follow-up with insights from top performers',
    category: 'Engagement'
  },
  {
    name: 'Gutcheck Follow-up 3 - Trajectory Development',
    filename: 'followup-3-corrected.html',
