...
async function testWebApp() {
  console.log('🚀 Testing your web app on different devices...\n');
  ...
  for (const device of devices) {
    ...
    try {
      ...
      if (assessmentLink) {
        ...
        const assessmentScreenshotPath = `screenshots/${device.name.replace(/[^a-zA-Z0-9]/g, '-').toLowerCase()}-assessment.png`;
        await page.screenshot({ 
  ...
  console.log('🔍 This will help you identify any Safari/Chrome rendering differences!');
}
