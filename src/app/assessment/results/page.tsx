        ...
        if (sessionId) {
          ...
          if (session) {
            ...
            const data: AssessmentSessionDTO = {
              ...
              starRating: session.starRating || 1,
            ...
            if (localData) {
              ...
              const mockSessionData: AssessmentSessionDTO = {
                ...
                scores: {
                  overallScore: parsedData.scores?.overallScore || 0,
                  personalBackground: parsedData.scores?.personalBackground || 0,
                  entrepreneurialSkills: parsedData.scores?.entrepreneurialSkills || 0,
                  resources: parsedData.scores?.resources || 0,
                  behavioralMetrics: parsedData.scores?.behavioralMetrics || 0,
                  growthVision: parsedData.scores?.growthVision || 0,
                },
                starRating: parsedData.starRating || 1,
                categoryBreakdown: parsedData.categoryBreakdown || {},
                geminiFeedback: parsedData.geminiFeedback || null,
                createdAt: new Date(),
